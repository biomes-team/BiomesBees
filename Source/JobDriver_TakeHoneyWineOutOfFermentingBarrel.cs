...
public class JobDriver_TakeHoneyWineOutOfFermentingBarrel : JobDriver
{
    ...
    protected Building_HoneyFermentingBarrel Barrel => (Building_HoneyFermentingBarrel) job.GetTarget(TargetIndex.A).Thing;
